  ...
  return (
    <div>
      <button
        ...
        className="focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 rounded-sm"
        style={{
          width: '100%',
          background: 'none',
          border: 'none',
      ...
      <div id={contentId} style={{ display: open ? 'block' : 'none', paddingBottom: 8 }}>{children}</div>
    </div>
  )
}
