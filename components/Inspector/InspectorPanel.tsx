  ...
  return (
    <div>
      <button
        ...
        className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 rounded-sm"
        style={{
          width: '100%',
          background: 'none',
          border: 'none',
      ...
      <div id={contentId} style={{ paddingBottom: 8, display: open ? 'block' : 'none' }}>
        {children}
      </div>
    </div>
  )
