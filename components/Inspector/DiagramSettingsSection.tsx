    ...
    <div>
      ...
      >
        ...
        <div style={{ marginBottom: 10 }}>
          <select value={theme} onChange={(e) => setTheme(e.target.value as Theme)} className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500" style={selectStyle} aria-label="Theme">
        ...
        <div style={{ marginBottom: 10 }}>
          <select value={curveStyle} onChange={(e) => setCurveStyle(e.target.value as CurveStyle)} className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500" style={selectStyle} aria-label="Curve Style">
